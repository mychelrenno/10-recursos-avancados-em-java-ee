...
import br.com.javaEstudo.dao.DAOUserMySQL;
import br.com.javaEstudo.models.User;

@WebServlet("/pages/carregarDadosDataTable")
public class ServeletDataTable extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	private DAOUserMySQL usuarioDAO = new DAOUserMySQL();
       
    public ServeletDataTable() {
        super();
    }
...
//		System.out.println("doGet sendo chamado pelo dataTable");
		try {
			...
			List<User> usuarios = usuarioDAO.getUsuarios(search);
			String json = "";
