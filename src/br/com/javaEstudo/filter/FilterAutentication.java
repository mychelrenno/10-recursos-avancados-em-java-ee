...
public class FilterAutentication implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		UserLogged userLogado = (UserLogged) session.getAttribute("usuario");
		
//		System.out.println(req.getServletPath());
		String urlParaAutenticar = req.getServletPath();
		
		if (userLogado == null && !urlParaAutenticar.equalsIgnoreCase("/pages/ServletAuthentication")) {
			RequestDispatcher dispatcher = request.getRequestDispatcher("/authenticate.jsp?url=" + urlParaAutenticar);
